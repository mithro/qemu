...
/*
 * REAL 256-byte SPD of the DIMM in slot A2 — read from silicon on 2026-07-18
 * by the BMC's own at24 driver over I2C2 through the QU9/QU5-Y2 fabric (with
 * the mux held at Y2; see I2C-MUX-FABRIC-ARBITRATION.md and
 * evidence/d08-spd-silicon/). A 4 GB DDR3 UDIMM, part "RMR5030EF68F9W1600",
 * serial 420B469C (== the host's dmidecode -t 17). CRC-16 over bytes 0-116 =
 * 0xf0b4 (byte0 bit7=1), verified. Byte 3 = 0x02 (UNBUFFERED), byte 32 = 0x00
 * (NO thermal sensor) — which is why silicon 0x19 (TSOD) NAKs, so the model
 * deliberately does NOT place a jc42 here (faithfulness: QEMU models THIS
 * rig's DIMM, not a generic TS-equipped one).
 */
static const uint8_t kgpe_d16_dimm_a2_spd[256] = {
    ,
};
...
static void kgpe_d16_bmc_i2c_fabric_init(AspeedMachineState *bmc)
{
     ...
     * 0x51 per the SA-strap map in I2C-MUX-FABRIC-ARBITRATION.md §5b. No TSOD:
     * the rig's UDIMM has SPD byte32=0 (no thermal sensor), matching silicon
     * where 0x19 NAKs. A TS-equipped DIMM would add a "jc42" at 0x18+slot here
     * (the jc42 model, hw/sensor/jc42.c, is available for such configs).
     */
